package com.example.zoomstudy.initsdk;
...
public class InitAuthSDKHelper implements AuthConstants, ZoomSDKInitializeListener {
    ...
    private static InitAuthSDKCallback mInitAuthSDKCallback;
    ...
    public void initSDK(Context context, InitAuthSDKCallback callback) {
        if (!mZoomSDK.isInitialized()) {
            ...
            initParams.appKey = "kvEqwIW6dlshgSuucT5HLJyarEYI9fXKAIa9";
            initParams.appSecret = "sxvy8YeKWdnQ1vVqOn3a55Uj1rDlzkMYmuNj";
